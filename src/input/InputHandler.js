...
import { textureLevel } from 'three/src/nodes/accessors/TextureNode.js';
...
export class InputHandler {
    ...
    constructor(camera) {
        ...
        this.keys = { w: false, a: false, s: false, d: false, i: false, o: false, p: false};
    ...
    // checks if I is pressed
    getHide() {
        if (this.keys.i) { return true; }
        else             { return false; }
    }

    // checks if O is pressed
    getBark() {
        if (this.keys.o) { return true; }
        else             { return false; }
    }

    // checks if P is pressed
    getDrop() {
        if (this.keys.p) { return true; }
        else             { return false; }
    }
